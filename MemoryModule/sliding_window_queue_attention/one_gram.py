...
class WhisperDecoderLayer(nn.Module):
    ...
    Layer structure for use_queue=True:
    ...
    def __init__(self, config: WhisperConfig, layer_idx: int = None):
        ...
        self.use_queue = (layer_idx is not None) and (layer_idx > 2)
    ...
    def forward(
        ...
        if self.use_queue:
            ...
            hidden_states = hidden_states + gate * queue_update
...
class WhisperDecoder(WhisperPreTrainedModel):
    ...
    def _init_queue_adapters(self) -> None:
        ...
        for layer in self.layers:
            if getattr(layer, "use_queue", False):
