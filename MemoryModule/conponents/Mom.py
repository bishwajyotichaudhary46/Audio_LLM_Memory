...
class MOM(nn.Module):
    def __init__(
        ...
        # Projections
        self.query_proj = nn.Linear(n_text_state, n_text_state)

        # Output projection
        self.W = nn.Linear(n_text_state, n_text_state)
        ...
        self.shared_mem = LinearAttentionMem(n_text_state=self.n_text_state, n_heads= self.n_heads)
    ...
    def split_head(self, t):
        ...
        """
        B, S, _ = t.shape
        return t.view(B, S, self.n_heads, self.n_text_state//self.n_heads)
    ...
    def mixed_head(self, t):
        ...
        """
        B, S, _,_ = t.shape
        return t.view(B, S, self.n_text_state)
    ...
    def forward(self, x):
        ...
        o = torch.einsum('bshv,bhkv->bshv', q, final_memory)
