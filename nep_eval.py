...
#    "artifacts/context_full_tunning_huge/checkpoint-16978"
# ).to(device)

model = WhisperCustom.from_pretrained(
    "artifacts/transcribe/memory/last_layer/sft/memory_router_alpha_only/best_model",
...
dataset = load_from_disk("Data/hf_eval_ne")
